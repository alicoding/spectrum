module.exports = function (es, app) {
  ...
  functions.getPost = function (req, res, next) {
    ...
    es.get({
      ...
      objectBeautifier(result, function (content) {
        ...
        parseToHTML(content.content, function(data) { 
    ...
    if (content instanceof Array) {
      content.forEach(function (item) {
        newObject = {
          ...
          postedOn: date = new Date(item._source._postedOn)
        }
      ...
      newObject = {
        ...
        postedOn: date = new Date(content._source._postedOn),
  ...
  functions.editorPreview = function ( req, res ) {
    ...
    parseToHTML(data, function (err, data) {
      if(err) {
        return res.json(err);
      }
